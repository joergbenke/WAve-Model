...
CONTAINS
  ...
  SUBROUTINE WRITE_PREPROC_FILE
    ...
    call check( nf90_def_var(ncid, "dfimofr", NF90_DOUBLE, (/ dimid_ml /), varid_dfimofr), "nf90_def_var DFIMOFR" )
    ...
    ! ---------------------------------------------------------------------------- !
    !                                                                              !
    !     3. WRITE FINE GRID BOUNDARY INPUT INFORMATION. (write part)              !
    !        -------------------------------------------                           !
    ...
    call check( nf90_put_var(ncid, varid_l_s_mask, merge(1, 0, L_S_MASK)), "nf90_put_var L_S_MASK" )
